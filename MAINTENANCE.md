...
- key: J12                       # μοναδικό αναγνωριστικό (δικό σου)
  ...
  status: published              # published | under_review | accepted | submitted | forthcoming
```
...
Όλα στο `config/_default/params.toml`: email, ORCID, Scholar, Scopus, Semantic
Scholar, GitHub, LinkedIn, ResearchGate, και ο πίνακας `[bibliometrics]`
(citations / h-index): ανανέωσέ τα πριν από milestones.
